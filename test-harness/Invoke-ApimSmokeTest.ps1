...
$ApimEndpoints = @{
    dev  = "https://amn-wus2-hub-apim-d02.azure-api.net/mcp/sfdc-read/dev"
    int  = "https://amn-wus2-hub-apim-i02.azure-api.net/mcp/sfdc-read/int"
    prod = "https://amn-wus2-hub-apim-p02.azure-api.net/mcp/sfdc-read/prod"
}
