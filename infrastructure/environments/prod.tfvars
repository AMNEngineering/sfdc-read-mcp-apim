...
# Entra app registration for Power Automate / Copilot Studio client (placeholder)
# Replace with the PROD equivalent of the SFDCRead INT MCP app
sfdc_read_mcp_copilot_app_id = ""
